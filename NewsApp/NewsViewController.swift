...
//  NewsApp
//
//  Created by Sho Nozaki on 2018/10/04.
...
class NewsViewController: UIViewController {
    ...
    func initSegmentControl() {
        ...
        segmentControl.segments = [
            ...
            TextSegment(text: "Yahoo!", otherAttr: "Yahoo!"),
            TextSegment(text: "CNET", otherAttr: "CNET"),
            TextSegment(text: "Qiita", otherAttr: "Qiita"),
            TextSegment(text: "GitHub", otherAttr: "GitHub"),
        ]
        segmentControl.style = .rainbow
        segmentControl.segmentTextFontSize = 12.0 // メニューのフォントサイズの調整
...
//            UIColor(red:0.47, green:0.78, blue:0.97, alpha:1.00)
            ...
            UIColor(red: 0.91, green: 0.18, blue: 0.24, alpha: 1.00),
            UIColor(red: 1.00, green: 0.71, blue: 0.26, alpha: 1.00),
            UIColor(red: 0.00, green: 1.00, blue: 0.20, alpha: 1.00),
            UIColor(red: 0.47, green: 0.78, blue: 0.97, alpha: 1.00)
        ]
...
extension NewsViewController: WBSegmentControlDelegate {
